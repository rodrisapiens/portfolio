...
export const info=[
    {
        ...
        cardDescription:"a tourism start up´s web page,designed and developed by me using figma,html,css,javasScript and React. It has some unique animations using svg.",
        cardImage:delta,
        photoRigth:true,
        bg:"#711A75"
    },
    {
        ...
        cardDescription:"a comment section designed by Front end Mentor. I used html,css and React fort the front end and FireBase for user identification with google and database.",
        cardImage:comments,
        photoRigth:false,
        bg:"#F10086"
    },
